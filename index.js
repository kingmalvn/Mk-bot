...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async m => {
            ...
            const km = "263780166288";
            const mk = "263714757857";
...
╔───❃
 𝒓𝒆𝒑𝒐𝒓𝒕 𝒂𝒏𝒚. 𝒑𝒓𝒐𝒃𝒍𝒆𝒎𝒔 𝒕𝒐 𝒕𝒉𝒆 𝒅𝒆𝒗𝒔:) 
 𝑻𝒉𝒂𝒏𝒌𝒔 𝒇𝒐𝒓 𝒔𝒖𝒑𝒑𝒐𝒓𝒕𝒊𝒏𝒈 𝒕𝒉𝒊𝒔 𝒑𝒓𝒐𝒋𝒆𝒄𝒕
 𝒑𝒓𝒐𝒑𝒆𝒓𝒕𝒚 𝒐𝒇 Ƙιƞϑ ʍαℓ⋎ιƞ
 𝒑𝒓𝒐𝒑𝒆𝒓𝒕𝒚 𝒐𝒇 Ƙιƞϑ ʍαℓ⋎ιƞ
 © 𝗸𝗶𝗻𝗴𝗺𝗮𝗹𝘃𝗻 
 © 𝕸𝖆𝖑𝖛𝖎𝖓 𝕶𝖎𝖓𝖌
╚─────────────────···▸▸`;
